...
keyboard.add_button('Календарь релизов', color=VkKeyboardColor.SECONDARY)
keyboard.add_line()
keyboard.add_button('Связь с админом', color=VkKeyboardColor.POSITIVE)
keyboard.add_line()
keyboard.add_button('Перезагрузить бота', color=VkKeyboardColor.NEGATIVE)

# для админа
keyboard_admin = VkKeyboard(one_time=False)
keyboard_admin.add_button('Загрузить фото', color=VkKeyboardColor.POSITIVE)
keyboard_admin.add_line()
keyboard_admin.add_button('Очистить список релизов', color=VkKeyboardColor.PRIMARY)
keyboard_admin.add_line()
keyboard_admin.add_button('Выход', color=VkKeyboardColor.NEGATIVE)

# для товаров
keyboard_product = VkKeyboard(one_time=False)
keyboard_product.add_button('Legit Check', color=VkKeyboardColor.SECONDARY)
keyboard_product.add_line()
keyboard_product.add_button('Гарант', color=VkKeyboardColor.SECONDARY)
keyboard_product.add_line()
keyboard_product.add_button('Продажа за границу', color=VkKeyboardColor.SECONDARY)
keyboard_product.add_line()
keyboard_product.add_button('Реклама', color=VkKeyboardColor.SECONDARY)
keyboard_product.add_line()
keyboard_product.add_button('Назад', color=VkKeyboardColor.NEGATIVE)
