...
keyboard.add_button('Услуги группы')
keyboard.add_line()
keyboard.add_button('Таблица размеров')
keyboard.add_button('Календарь релизов')
keyboard.add_line()
...
keyboard_admin.add_button('Загрузить фото')
keyboard_admin.add_line()
keyboard_admin.add_button('Очистить список релизов')
keyboard_admin.add_line()
keyboard_admin.add_button('Выход')

# для товаров
keyboard_product = VkKeyboard(one_time=False)
keyboard_product.add_button('Legit Check')
keyboard_product.add_line()
keyboard_product.add_button('Гарант')
keyboard_product.add_line()
keyboard_product.add_button('Продажа за границу')
keyboard_product.add_line()
keyboard_product.add_button('Реклама')
keyboard_product.add_line()
keyboard_product.add_button('Назад')
